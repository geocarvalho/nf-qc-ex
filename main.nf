...
params.sample_name = 'SRR28520745'
...
params.cnv_merge = "s3://bioinfo-resources/wes-assets/exomedepth/SRR28520745_CNVs_ExomeDepth.txt"

log.info """\
    EX _ W F   P I P E L I N E
    ===================================
    sample_name     : ${params.sample_name}
    cnv_merge       : ${params.cnv_merge}
    """
    .stripIndent(true)
...
include { BED2BW } from './bed2bw/main'
